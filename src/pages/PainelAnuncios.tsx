...
const PainelAnuncios: React.FC = () => {
  ...
  const [modoAnuncio, setModoAnuncio] = useState<'proprios' | 'adsense'>('proprios');
  ...
  const salvarConfiguracoes = () => {
    toast({
      ...
      description: `Suas preferências de anúncios foram atualizadas para modo: ${modoAnuncio === 'proprios' ? 'Anúncios próprios' : 'Google AdSense'}.`,
    });
  };
  ...
  return (
    <div className="min-h-screen bg-fila-fundo">
      ...
      <div className="container mx-auto py-6 px-4 max-w-7xl">
        ...
        {/* Cabeçalho da página */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Configurações & Análise de Anúncios</h1>
          <p className="text-lg text-gray-600 mt-2">
            Monitore o desempenho de sua tela pública e configure suas preferências de exibição de anúncios.
          </p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Escolha como você deseja que os anúncios sejam exibidos na sua tela pública.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <RadioGroup 
              value={modoAnuncio} 
              onValueChange={(valor) => alternarModoAnuncio(valor as 'proprios' | 'adsense')}
              className="grid grid-cols-1 md:grid-cols-2 gap-4"
            >
              <div className={`border rounded-lg p-4 ${modoAnuncio === 'proprios' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}>
                <div className="flex items-start space-x-2">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Tenha controle total sobre o conteúdo exibido em sua tela pública. 
                      Carregue suas próprias imagens promocionais.
                    </p>
              ...
              <div className={`border rounded-lg p-4 ${modoAnuncio === 'adsense' ? 'border-green-500 bg-green-50' : 'border-gray-200'}`}>
                <div className="flex items-start space-x-2">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Permita que o Google AdSense exiba anúncios em sua tela e ganhe 
                      uma comissão por impressão e clique.
                    </p>
        ...
        {/* Seção de Análise */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Análise de Desempenho</h2>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-3xl font-bold text-blue-800">{dadosAnaliticos.tempoAtivo.total}</p>
                </div>
                <div className="bg-indigo-50 p-4 rounded-lg">
                  <p className="text-indigo-700 font-medium">Média Diária</p>
                  <p className="text-3xl font-bold text-indigo-800">{dadosAnaliticos.tempoAtivo.mediaDiaria}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <p className="text-purple-700 font-medium">Sessões Ativas</p>
                  <p className="text-3xl font-bold text-purple-800">{dadosAnaliticos.tempoAtivo.sessoesAtivas}</p>
          ...
          {modoAnuncio === 'proprios' ? (
            <>
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Prévia da Tela Pública</h2>
                <p className="text-gray-600 mb-4">Esta é uma simulação de como seus anúncios aparecerão na tela pública:</p>
                <PreviewTelaPublica />
              </div>
            </>
          ) : (
            <>
              ...
              <div className="mt-8 mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Relatório de Desempenho do AdSense</h2>
                <RelatorioAdSense />
              </div>
            </>
          )}
